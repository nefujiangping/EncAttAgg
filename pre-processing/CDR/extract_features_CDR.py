...
def main_extract_bert_tokens(_):
  """
  python extract_features.py --input_file=E:/workspace/repo/bran/data/cdr/CDR_DevelopmentSet.PubTator.txt/dev_train_text.txt --output_file=E:/workspace/repo/bran/data/cdr/CDR_DevelopmentSet.PubTator.txt/dev_train_text.txt --vocab_file=F:/sciBERT/vocab.txt --bert_config_file=F:/sciBERT/bert_config.json --init_checkpoint=F:/sciBERT/bert_model.ckpt --layers=-1 --max_seq_length=512 --batch_size=8
  """
  tf.logging.set_verbosity(tf.logging.INFO)
  ...
  NUM = num_dict[split]
  with open('E:/workspace/repo/bran/data/cdr/CDR_DevelopmentSet.PubTator.txt/dev_%s_bert_text.json' % split, 'w', encoding='utf8') as writer:
